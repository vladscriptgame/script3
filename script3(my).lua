...
local Window = Library.CreateLib('Чит для скоростных дуэлей', 'RJTheme3')

local Tab = Window:NewTab('Основное')

local Section = Tab:NewSection('В разработке')

local Tab2  = Window:NewTab('Визуал')

local Section2 = Tab2:NewSection('Esp')

Section2:NewButton('Esp', 'Видимость через стены других игроков', function()
